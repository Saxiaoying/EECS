...
public class CourseContent {
	...
	@JSONField(ordinal = 7)
	private int cont_method;//教学方法与要求
	...
	public int getCont_method() {
		return cont_method;
	}

	public void setCont_method(int cont_method) {
	...
	public int getCont_cla_exe() {
		return cont_cla_exe;
	}

	public void setCont_cla_exe(int cont_cla_exe) {
