...
public interface CourseContentDao {
	...
	void addCourseContent(int cs_id, int cont_typ, String cont_name,int cont_num, 
	...
	//删除
	@Transactional(propagation = Propagation.REQUIRED)
	void deleteCourseContentByCoz_id(int cs_id, int cont_num);
	
	//修改
	@Transactional(propagation = Propagation.REQUIRED)
	void updateCourseContent(int cs_id, int cont_typ, String cont_name,int cont_num, 
			String cont_cont, String cont_method, String cont_key, String cont_diff, 
			double cont_hrs_tch, double cont_hrs_pr, String cont_cla_exe, String cont_hw);
}
